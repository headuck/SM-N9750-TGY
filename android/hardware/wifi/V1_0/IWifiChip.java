...
public interface IWifiChip extends IBase {
    ...
    public static final class ChipMode {
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (this.f0id == other.f0id && HidlSupport.deepEquals(this.availableCombinations, other.availableCombinations)) {
                return true;
            }
            return false;
        }
        ...
        public final int hashCode() {
            return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f0id))), Integer.valueOf(HidlSupport.deepHashCode(this.availableCombinations))});
        }

        public final String toString() {
            return "{" + ".id = " + this.f0id + ", .availableCombinations = " + this.availableCombinations + "}";
        }
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            HwBlob hwBlob = _hidl_blob;
            this.f0id = hwBlob.getInt32(_hidl_offset + 0);
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            _hidl_blob.putInt32(_hidl_offset + 0, this.f0id);
    ...
    public static abstract class Stub extends HwBinder implements IWifiChip {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-13, -18, -52, 72, -99, -21, 76, 116, -119, 47, 89, -21, 122, -37, 118, -112, 99, -67, 92, 53, 74, -63, 50, -74, 38, -91, -12, 43, 54, 61, 54, -68}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}}));
        }
