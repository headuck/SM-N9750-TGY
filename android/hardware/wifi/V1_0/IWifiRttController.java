...
public interface IWifiRttController extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IWifiRttController {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{118, 110, -105, 101, -11, -55, -57, 89, -78, -89, 99, -62, SemWifiApSmartUtil.BLE_BATT_5, -125, 83, -5, 93, -17, -13, 56, -100, 44, -62, -113, -127, -41, -100, -109, -105, 4, -50, -117}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 4:
                    ...
                    arrayList.clear();
                    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size2; _hidl_index_0++) {
                ...
                default:
                    switch (_hidl_code) {
                        ...
                        case 256398152:
                            ...
                            for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size3; _hidl_index_02++) {
