...
public interface IWifiStaIfaceEventCallback extends IBase {
    ...
    public static final class Proxy implements IWifiStaIfaceEventCallback {
        ...
        public void onRssiThresholdBreached(int cmdId, byte[] currBssid, int currRssi) throws RemoteException {
            ...
            byte[] _hidl_array_item_0 = currBssid;
    ...
    public static abstract class Stub extends HwBinder implements IWifiStaIfaceEventCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{Byte.MAX_VALUE, -65, -59, 81, -61, -30, 60, -117, 67, -104, -61, -31, 110, 69, 43, 81, 100, 87, -26, -110, 20, 36, -91, 52, 116, -53, -13, 115, -54, SemWifiApSmartUtil.BLE_BATT_6, 111, -87}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}}));
        }
