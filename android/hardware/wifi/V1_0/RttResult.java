...
public final class RttResult {
    ...
    public final String toString() {
        return "{" + ".addr = " + Arrays.toString(this.addr) + ", .burstNum = " + this.burstNum + ", .measurementNumber = " + this.measurementNumber + ", .successNumber = " + this.successNumber + ", .numberPerBurstPeer = " + this.numberPerBurstPeer + ", .status = " + RttStatus.toString(this.status) + ", .retryAfterDuration = " + this.retryAfterDuration + ", .type = " + RttType.toString(this.type) + ", .rssi = " + this.rssi + ", .rssiSpread = " + this.rssiSpread + ", .txRate = " + this.txRate + ", .rxRate = " + this.rxRate + ", .rtt = " + this.rtt + ", .rttSd = " + this.rttSd + ", .rttSpread = " + this.rttSpread + ", .distanceInMm = " + this.distanceInMm + ", .distanceSdInMm = " + this.distanceSdInMm + ", .distanceSpreadInMm = " + this.distanceSpreadInMm + ", .timeStampInUs = " + this.timeStampInUs + ", .burstDurationInMs = " + this.burstDurationInMs + ", .negotiatedBurstNum = " + this.negotiatedBurstNum + ", .lci = " + this.lci + ", .lcr = " + this.lcr + "}";
    }
