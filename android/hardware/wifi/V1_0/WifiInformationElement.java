...
public final class WifiInformationElement {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.f5id == other.f5id && HidlSupport.deepEquals(this.data, other.data)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.f5id))), Integer.valueOf(HidlSupport.deepHashCode(this.data))});
    }

    public final String toString() {
        return "{" + ".id = " + this.f5id + ", .data = " + this.data + "}";
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f5id = hwBlob.getInt8(_hidl_offset + 0);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putInt8(_hidl_offset + 0, this.f5id);
