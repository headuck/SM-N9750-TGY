...
public final class WifiRateInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.preamble == other.preamble && this.nss == other.nss && this.f6bw == other.f6bw && this.rateMcsIdx == other.rateMcsIdx && this.bitRateInKbps == other.bitRateInKbps) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.preamble))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.nss))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f6bw))), Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.rateMcsIdx))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.bitRateInKbps)))});
    }

    public final String toString() {
        return "{" + ".preamble = " + WifiRatePreamble.toString(this.preamble) + ", .nss = " + WifiRateNss.toString(this.nss) + ", .bw = " + WifiChannelWidthInMhz.toString(this.f6bw) + ", .rateMcsIdx = " + this.rateMcsIdx + ", .bitRateInKbps = " + this.bitRateInKbps + "}";
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f6bw = _hidl_blob.getInt32(8 + _hidl_offset);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt32(8 + _hidl_offset, this.f6bw);
