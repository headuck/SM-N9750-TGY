...
public interface IWifiStaIface extends android.hardware.wifi.V1_2.IWifiStaIface {
    ...
    public static abstract class Stub extends HwBinder implements IWifiStaIface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IWifiStaIface.kInterfaceName, android.hardware.wifi.V1_2.IWifiStaIface.kInterfaceName, android.hardware.wifi.V1_0.IWifiStaIface.kInterfaceName, IWifiIface.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 26:
                    ...
                    hwParcel.enforceInterface(android.hardware.wifi.V1_2.IWifiStaIface.kInterfaceName);
