...
public interface IHostapd extends android.hardware.wifi.hostapd.V1_0.IHostapd {
    ...
    public static final class ChannelParams {
        ...
        public final int hashCode() {
            return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(this.acsChannelRanges))});
        }
    ...
    public static final class IfaceParams {
        ...
        public final int hashCode() {
            return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(this.V1_0)), Integer.valueOf(HidlSupport.deepHashCode(this.channelParams))});
        }
    ...
    public static abstract class Stub extends HwBinder implements IHostapd {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IHostapd.kInterfaceName, android.hardware.wifi.hostapd.V1_0.IHostapd.kInterfaceName, IBase.kInterfaceName}));
        }
