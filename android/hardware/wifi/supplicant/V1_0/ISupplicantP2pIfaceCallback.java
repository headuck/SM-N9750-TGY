...
public interface ISupplicantP2pIfaceCallback extends IBase {
    ...
    public static final class Proxy implements ISupplicantP2pIfaceCallback {
        ...
        public void onInvitationReceived(byte[] srcAddress, byte[] goDeviceAddress, byte[] bssid, int persistentNetworkId, int operatingFrequency) throws RemoteException {
            ...
            byte[] _hidl_array_item_03 = bssid;
            if (_hidl_array_item_03 == null || _hidl_array_item_03.length != 6) {
                throw new IllegalArgumentException("Array element is not of the expected length");
            }
            _hidl_blob3.putInt8Array(0, _hidl_array_item_03);
            _hidl_request.writeBuffer(_hidl_blob3);
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantP2pIfaceCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-117, 99, -11, -17, -94, -29, -66, 58, 124, -72, -92, SemWifiApSmartUtil.BLE_BATT_5, 118, 13, -126, SemWifiApSmartUtil.BLE_BATT_5, 90, 74, -73, -101, -53, -34, -90, -17, -112, -86, 84, 117, 85, -27, -126, -44}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}}));
        }
