...
public interface ISupplicantStaNetwork extends ISupplicantNetwork {
    ...
    public static final class NetworkResponseEapSimGsmAuthParams {
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (HidlSupport.deepEquals(this.f8kc, other.f8kc) && HidlSupport.deepEquals(this.sres, other.sres)) {
                return true;
            }
            return false;
        }
        ...
        public final int hashCode() {
            return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(this.f8kc)), Integer.valueOf(HidlSupport.deepHashCode(this.sres))});
        }

        public final String toString() {
            return "{" + ".kc = " + Arrays.toString(this.f8kc) + ", .sres = " + Arrays.toString(this.sres) + "}";
        }
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            _hidl_blob.copyToInt8Array(0 + _hidl_offset, this.f8kc, 8);
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            ...
            byte[] _hidl_array_item_0 = this.f8kc;
    ...
    public static final class NetworkResponseEapSimUmtsAuthParams {
        ...
        /* renamed from: ck */
        public byte[] f9ck = new byte[16];

        /* renamed from: ik */
        public byte[] f10ik = new byte[16];
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (HidlSupport.deepEquals(this.res, other.res) && HidlSupport.deepEquals(this.f10ik, other.f10ik) && HidlSupport.deepEquals(this.f9ck, other.f9ck)) {
                return true;
            }
            return false;
        }
        ...
        public final int hashCode() {
            return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(this.res)), Integer.valueOf(HidlSupport.deepHashCode(this.f10ik)), Integer.valueOf(HidlSupport.deepHashCode(this.f9ck))});
        }

        public final String toString() {
            return "{" + ".res = " + this.res + ", .ik = " + Arrays.toString(this.f10ik) + ", .ck = " + Arrays.toString(this.f9ck) + "}";
        }
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            ...
            hwBlob.copyToInt8Array(_hidl_offset + 16, this.f10ik, 16);
            hwBlob.copyToInt8Array(_hidl_offset + 32, this.f9ck, 16);
        }
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantStaNetwork {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-79, 46, -16, -67, -40, -92, -46, 71, -88, -90, -23, 96, -78, 39, -19, 50, 56, 63, 43, 2, 65, -11, 93, 103, -4, -22, 110, -1, 106, 103, 55, -6}, new byte[]{-51, -96, SemWifiApSmartUtil.BLE_BATT_2, 8, -64, 105, 34, -6, 55, -63, 33, 62, -101, -72, 49, -95, 9, -77, 23, 69, 50, Byte.MIN_VALUE, 86, 22, -5, 113, 97, -19, -60, 3, -122, 111}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 69:
                    ...
                    _hidl_reply.send();
                    return;
                case SemWifiFrameworkUxUtils.INFO_TYPE_NETWORK_CONNECT_FAILED /*70*/:
                    if (_hidl_flags == false || !true) {
                        _hidl_is_oneway2 = false;
                    }
                    if (_hidl_is_oneway2) {
