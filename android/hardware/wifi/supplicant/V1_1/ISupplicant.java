...
public interface ISupplicant extends android.hardware.wifi.supplicant.V1_0.ISupplicant {
    ...
    public static final class Proxy implements ISupplicant {
        ...
        public void addInterface(ISupplicant.IfaceInfo ifaceInfo, addInterfaceCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements ISupplicant {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-29, 98, SemWifiApSmartUtil.BLE_BATT_4, 59, -108, 31, SemWifiApSmartUtil.BLE_BATT_3, -67, 76, -70, 41, -90, 42, -33, -96, 36, 83, -19, 0, -42, -66, 91, 114, -51, -74, -60, -41, -32, -65, 57, 74, SemWifiApSmartUtil.BLE_WIFI}, new byte[]{-9, -27, 92, 8, SemWifiApSmartUtil.BLE_BATT_3, 125, -116, -123, 80, 104, -95, -18, 61, 12, -115, -82, -18, 117, 112, 41, 45, -106, 80, -100, 33, -88, 117, 109, 79, 92, -5, -101}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}}));
        }
