...
public interface ISupplicantStaIface extends android.hardware.wifi.supplicant.V1_1.ISupplicantStaIface {
    ...
    public static final class Proxy implements ISupplicantStaIface {
        ...
        public SupplicantStatus initiateTdlsDiscover(byte[] macAddress) throws RemoteException {
            ...
            byte[] _hidl_array_item_0 = macAddress;
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantStaIface {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{126, -2, 43, 5, 126, -97, -109, -121, -77, 80, 14, 103, -81, -105, -108, 42, -89, -56, 0, -114, 110, -25, -40, -36, -86, -28, SemWifiApSmartUtil.BLE_BATT_2, Byte.MAX_VALUE, -38, -124, 1, 107}, new byte[]{33, 117, 125, 14, 93, -44, -73, -28, -67, -104, 26, 74, SemWifiApSmartUtil.BLE_BATT_4, 83, 27, -54, 60, 50, 39, 26, -39, 119, 123, 23, -73, 78, -75, -95, -22, 80, -125, -124}, new byte[]{119, 82, -31, -34, -109, -86, -11, -2, -45, 112, 17, -62, 25, -84, 36, 112, 105, -10, -81, 50, 11, 8, SemWifiApSmartUtil.BLE_BATT_2, -38, -87, -123, SemWifiApSmartUtil.BLE_BATT_2, 88, 74, SemWifiApSmartUtil.BLE_BATT_2, -25, -76}, new byte[]{53, -70, 123, -51, -15, -113, 36, -88, 102, -89, -27, 66, -107, 72, -16, 103, 104, -69, SemWifiApSmartUtil.BLE_BATT_4, -94, 87, -9, 91, SemWifiApSmartUtil.BLE_BATT_2, -93, -105, -60, -40, 37, -17, -124, 56}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 19:
                    ...
                    hwParcel.readBuffer(6).copyToInt8Array(0, macAddress, 6);
                ...
                case 20:
                    ...
                    hwParcel.readBuffer(6).copyToInt8Array(0, macAddress2, 6);
                ...
                case ISupplicantStaIfaceCallback.ReasonCode.UNSUPPORTED_RSN_IE_VERSION:
                    ...
                    hwParcel.readBuffer(6).copyToInt8Array(0, macAddress3, 6);
                ...
                case 22:
                    ...
                    hwParcel.readBuffer(6).copyToInt8Array(0, macAddress4, 6);
                ...
                case 23:
                    ...
                    hwParcel.readBuffer(6).copyToInt8Array(0, macAddress5, 6);
                ...
                case 24:
                    ...
                    getMacAddress(new ISupplicantStaIface.getMacAddressCallback() {
                        public void onValues(SupplicantStatus status, byte[] macAddr) {
                            ...
                            status.writeToParcel(hwParcel2);
                            HwBlob _hidl_blob = new HwBlob(6);
                            byte[] _hidl_array_item_0 = macAddr;
                            if (_hidl_array_item_0 == null || _hidl_array_item_0.length != 6) {
                                throw new IllegalArgumentException("Array element is not of the expected length");
                            }
                            _hidl_blob.putInt8Array(0, _hidl_array_item_0);
                ...
                case 32:
                    ...
                    hwParcel.readBuffer(2).copyToInt8Array(0, code, 2);
                ...
                case 36:
                    ...
                    hwParcel.readBuffer(6).copyToInt8Array(0, bssid3, 6);
                ...
                case 42:
                    ...
                    hwParcel.enforceInterface(android.hardware.wifi.supplicant.V1_1.ISupplicantStaIface.kInterfaceName);
                ...
                case 44:
                    ...
                    getKeyMgmtCapabilities(new getKeyMgmtCapabilitiesCallback() {
                        public void onValues(SupplicantStatus status, int keyMgmtMask) {
                            hwParcel2.writeStatus(0);
                            status.writeToParcel(hwParcel2);
                            hwParcel2.writeInt32(keyMgmtMask);
                            hwParcel2.send();
                        }
                    });
                    return;
