...
public class DppManager {
    ...
    private final WifiNative.DppEventCallback mDppEventCallback = new WifiNative.DppEventCallback() {
        public void onSuccessConfigReceived(WifiConfiguration newWifiConfiguration) {
            DppManager.this.mHandler.post(new Runnable(newWifiConfiguration) {
                ...
                public final void run() {
                    DppManager.C03871.this.lambda$onSuccessConfigReceived$0$DppManager$1(this.f$1);
                }
            });
        }
        ...
        public void onSuccessConfigSent() {
            DppManager.this.mHandler.post(new Runnable() {
                public final void run() {
                    DppManager.C03871.this.lambda$onSuccessConfigSent$1$DppManager$1();
                }
            });
        }
        ...
        public void onProgress(int dppStatusCode) {
            DppManager.this.mHandler.post(new Runnable(dppStatusCode) {
                ...
                public final void run() {
                    DppManager.C03871.this.lambda$onProgress$2$DppManager$1(this.f$1);
                }
            });
        }
        ...
        public void onFailure(int dppStatusCode) {
            DppManager.this.mHandler.post(new Runnable(dppStatusCode) {
                ...
                public final void run() {
                    DppManager.C03871.this.lambda$onFailure$3$DppManager$1(this.f$1);
                }
            });
        }
    ...
    private static String encodeStringToHex(String str) {
        ...
        for (char hexString : charsArray) {
            hexBuffer.append(Integer.toHexString(hexString));
        }
    ...
    public void startDppAsConfiguratorInitiator(int uid, IBinder binder, String enrolleeUri, int selectedNetworkId, int enrolleeNetworkRole, IDppCallback callback) {
        ...
        int i;
        int i2 = uid;
        String str = enrolleeUri;
        IDppCallback iDppCallback = callback;
        this.mDppMetrics.updateDppConfiguratorInitiatorRequests();
        if (this.mDppRequestInfo != null) {
            try {
                Log.e(TAG, "DPP request already in progress");
                Log.e(TAG, "Ongoing request UID: " + this.mDppRequestInfo.uid + ", new UID: " + i2);
                this.mDppMetrics.updateDppFailure(-5);
                iDppCallback.onFailure(-5);
            ...
            if (this.mClientIfaceName == null) {
                ...
                if (selectedNetwork == null) {
                    ...
                    if (selectedNetwork.allowedKeyManagement.get(8)) {
                        ...
                        if (selectedNetwork.preSharedKey.matches(String.format("[0-9A-Fa-f]{%d}", new Object[]{64}))) {
                    ...
                    dppRequestInfo.uid = i2;
                    dppRequestInfo.binder = binder;
                    dppRequestInfo.callback = iDppCallback;
                    if (!linkToDeath(dppRequestInfo)) {
                        onFailure(-7);
                        return;
                    }
                    logd("Interface " + this.mClientIfaceName + ": Initializing URI: " + str);
                    ...
                    int peerId = this.mWifiNative.addDppPeerUri(this.mClientIfaceName, str);
                    if (peerId < 0) {
                    ...
                    String str2 = this.mClientIfaceName;
                    String str3 = password;
                    int i4 = this.mDppRequestInfo.peerId;
                    if (enrolleeNetworkRole == 1) {
                        i = 1;
                    } else {
                        i = 0;
                    }
                    if (!wifiNative.startDppConfiguratorInitiator(str2, i4, 0, ssidEncoded, passwordEncoded, psk, i, securityAkm)) {
    ...
    public void cleanupDppResources() {
        ...
        if (this.mDppRequestInfo != null) {
            ...
            this.mDppRequestInfo.binder.unlinkToDeath(this.mDppRequestInfo.f18dr, 0);
    ...
    private static class DppRequestInfo {
        ...
        /* renamed from: dr */
        public IBinder.DeathRecipient f18dr;
        public int peerId;
        ...
        public String toString() {
            return "DppRequestInfo: uid=" + this.uid + ", binder=" + this.binder + ", dr=" + this.f18dr + ", callback=" + this.callback + ", peerId=" + this.peerId;
        }
    }
    ...
    private boolean linkToDeath(final DppRequestInfo dppRequestInfo) {
        dppRequestInfo.f18dr = new IBinder.DeathRecipient() {
            public void binderDied() {
                if (dppRequestInfo != null) {
                    ...
                    DppManager.this.mHandler.post(new Runnable() {
                        public final void run() {
                            DppManager.C03882.this.lambda$binderDied$0$DppManager$2();
                        }
                    });
                }
            }
        ...
        try {
            dppRequestInfo.binder.linkToDeath(dppRequestInfo.f18dr, 0);
            return true;
        } catch (RemoteException e) {
            Log.e(TAG, "Error on linkToDeath - " + e);
            dppRequestInfo.f18dr = null;
            return false;
        }
    }
}
