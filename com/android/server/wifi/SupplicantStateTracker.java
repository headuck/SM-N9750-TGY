...
public class SupplicantStateTracker extends StateMachine {
    ...
    public void transitionOnSupplicantStateChange(StateChangeResult stateChangeResult) {
        ...
        switch (C04161.$SwitchMap$android$net$wifi$SupplicantState[supState.ordinal()]) {
            case 1:
    ...
    public void sendSupplicantStateChangedBroadcast(SupplicantState state, boolean failedAuth, int reasonCode) {
        int supplState;
        switch (C04161.$SwitchMap$android$net$wifi$SupplicantState[state.ordinal()]) {
            case 1:
                supplState = 1;
                break;
            case 2:
        ...
        if (WifiMobileDeviceManager.getEnterprisePolicyEnabled(this.mContext, "content://com.sec.knox.provider2/WifiPolicy", "getPromptCredentialsEnabled") != 0) {
