...
public class WifiMetrics {
    ...
    private static final int[] LINK_PROBE_ELAPSED_TIME_MS_HISTOGRAM_BUCKETS = {5, 10, 15, 20, 25, 50, 100, 200, ReportIdKey.ID_AUTOWIFI_ILLEGAL_STATE, 800};
    ...
    private static final int[] WIFI_CONFIG_STORE_IO_DURATION_BUCKET_RANGES_MS = {50, 100, 150, 200, ReportIdKey.ID_DHCP_FAIL};
        ...
        public String toString() {
            ...
            synchronized (WifiMetrics.this.mLock) {
                ...
                switch (this.mConnectionEvent.level2FailureCode) {
                    case 1:
                        sb.append(WifiTransportLayerUtils.CATEGORY_PLAYSTORE_NONE);
                        break;
                    case 2:
    ...
    private void maybeIncrementRssiDeltaCount(int rssi) {
        if (this.mScanResultRssiTimestampMillis >= 0) {
            if (this.mClock.getElapsedSinceBootMillis() - this.mScanResultRssiTimestampMillis <= 3000 && rssi >= -127 && rssi <= 127) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void incrementAvailableNetworksHistograms(java.util.List<com.android.server.wifi.ScanDetail> r29, boolean r30) {
        /*
            r28 = this;
            r1 = r28
            java.lang.Object r2 = r1.mLock
            monitor-enter(r2)
            com.android.server.wifi.WifiConfigManager r0 = r1.mWifiConfigManager     // Catch:{ all -> 0x01b4 }
            if (r0 == 0) goto L_0x01b2
            com.android.server.wifi.WifiNetworkSelector r0 = r1.mWifiNetworkSelector     // Catch:{ all -> 0x01b4 }
            if (r0 == 0) goto L_0x01b2
            com.android.server.wifi.hotspot2.PasspointManager r0 = r1.mPasspointManager     // Catch:{ all -> 0x01b4 }
            if (r0 != 0) goto L_0x0013
            goto L_0x01b2
        L_0x0013:
            r0 = 1
            if (r30 != 0) goto L_0x001f
            com.android.server.wifi.nano.WifiMetricsProto$WifiLog r3 = r1.mWifiLogProto     // Catch:{ all -> 0x01b4 }
            int r4 = r3.partialAllSingleScanListenerResults     // Catch:{ all -> 0x01b4 }
            int r4 = r4 + r0
            r3.partialAllSingleScanListenerResults = r4     // Catch:{ all -> 0x01b4 }
            monitor-exit(r2)     // Catch:{ all -> 0x01b4 }
            return
        L_0x001f:
            java.util.HashSet r3 = new java.util.HashSet     // Catch:{ all -> 0x01b4 }
            r3.<init>()     // Catch:{ all -> 0x01b4 }
            r4 = 0
            java.util.HashSet r5 = new java.util.HashSet     // Catch:{ all -> 0x01b4 }
            r5.<init>()     // Catch:{ all -> 0x01b4 }
            r6 = 0
            java.util.HashSet r7 = new java.util.HashSet     // Catch:{ all -> 0x01b4 }
            r7.<init>()     // Catch:{ all -> 0x01b4 }
            r8 = 0
            r9 = 0
            java.util.HashSet r10 = new java.util.HashSet     // Catch:{ all -> 0x01b4 }
            r10.<init>()     // Catch:{ all -> 0x01b4 }
            r11 = 0
            r12 = 0
            r13 = 0
            java.util.HashMap r14 = new java.util.HashMap     // Catch:{ all -> 0x01b4 }
            r14.<init>()     // Catch:{ all -> 0x01b4 }
            java.util.HashMap r15 = new java.util.HashMap     // Catch:{ all -> 0x01b4 }
            r15.<init>()     // Catch:{ all -> 0x01b4 }
            r16 = 0
            java.util.Iterator r17 = r29.iterator()     // Catch:{ all -> 0x01b4 }
            r0 = r11
            r11 = r9
            r9 = r8
            r8 = r6
            ...
            r4 = r16
        L_0x0051:
            boolean r18 = r17.hasNext()     // Catch:{ all -> 0x01b4 }
            if (r18 == 0) goto L_0x00ee
            java.lang.Object r18 = r17.next()     // Catch:{ all -> 0x01b4 }
            com.android.server.wifi.ScanDetail r18 = (com.android.server.wifi.ScanDetail) r18     // Catch:{ all -> 0x01b4 }
            r19 = r18
            com.android.server.wifi.hotspot2.NetworkDetail r18 = r19.getNetworkDetail()     // Catch:{ all -> 0x01b4 }
            android.net.wifi.ScanResult r20 = r19.getScanResult()     // Catch:{ all -> 0x01b4 }
            r21 = r20
            boolean r20 = r18.is80211McResponderSupport()     // Catch:{ all -> 0x01b4 }
            if (r20 == 0) goto L_0x0071
            int r4 = r4 + 1
        L_0x0071:
            com.android.server.wifi.ScanResultMatchInfo r20 = com.android.server.wifi.ScanResultMatchInfo.fromScanResult(r21)     // Catch:{ all -> 0x01b4 }
            r22 = r20
            r20 = 0
            r23 = r4
            r4 = 0
            r24 = r15
            com.android.server.wifi.WifiNetworkSelector r15 = r1.mWifiNetworkSelector     // Catch:{ all -> 0x01b4 }
            r25 = r14
            r14 = r21
            boolean r15 = r15.isSignalTooWeak(r14)     // Catch:{ all -> 0x01b4 }
        ...
        L_0x0091:
            r15 = r22
            r3.add(r15)     // Catch:{ all -> 0x01b4 }
            int r6 = r6 + 1
            r21 = r6
            int r6 = r15.networkType     // Catch:{ all -> 0x01b4 }
            r22 = 0
        ...
        L_0x00a4:
            r26 = r14
            com.android.server.wifi.WifiConfigManager r14 = r1.mWifiConfigManager     // Catch:{ all -> 0x01b4 }
            r27 = r13
            r13 = r19
            android.net.wifi.WifiConfiguration r14 = r14.getConfiguredNetworkForScanDetail(r13)     // Catch:{ all -> 0x01b4 }
            if (r14 == 0) goto L_0x00c1
            boolean r19 = r14.isEphemeral()     // Catch:{ all -> 0x01b4 }
            if (r19 != 0) goto L_0x00c1
            boolean r19 = r14.isPasspoint()     // Catch:{ all -> 0x01b4 }
            if (r19 != 0) goto L_0x00c1
            r19 = 1
            goto L_0x00c3
        L_0x00c1:
        ...
        L_0x00c7:
            ...
            r5.add(r15)     // Catch:{ all -> 0x01b4 }
            int r8 = r8 + 1
        L_0x00ce:
            if (r19 == 0) goto L_0x00d5
            r7.add(r15)     // Catch:{ all -> 0x01b4 }
            int r9 = r9 + 1
        L_0x00d5:
        ...
        L_0x00ee:
            ...
            r25 = r14
            r24 = r15
            com.android.server.wifi.nano.WifiMetricsProto$WifiLog r13 = r1.mWifiLogProto     // Catch:{ all -> 0x01b4 }
            int r14 = r13.fullBandAllSingleScanListenerResults     // Catch:{ all -> 0x01b4 }
            r15 = 1
            int r14 = r14 + r15
            r13.fullBandAllSingleScanListenerResults = r14     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mTotalSsidsInScanHistogram     // Catch:{ all -> 0x01b4 }
            int r14 = r3.size()     // Catch:{ all -> 0x01b4 }
            r1.incrementTotalScanSsids(r13, r14)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mTotalBssidsInScanHistogram     // Catch:{ all -> 0x01b4 }
            r1.incrementTotalScanResults(r13, r6)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mAvailableOpenSsidsInScanHistogram     // Catch:{ all -> 0x01b4 }
            int r14 = r5.size()     // Catch:{ all -> 0x01b4 }
            r1.incrementSsid(r13, r14)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mAvailableOpenBssidsInScanHistogram     // Catch:{ all -> 0x01b4 }
            r1.incrementBssid(r13, r8)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mAvailableSavedSsidsInScanHistogram     // Catch:{ all -> 0x01b4 }
            int r14 = r7.size()     // Catch:{ all -> 0x01b4 }
            r1.incrementSsid(r13, r14)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mAvailableSavedBssidsInScanHistogram     // Catch:{ all -> 0x01b4 }
            r1.incrementBssid(r13, r9)     // Catch:{ all -> 0x01b4 }
            r5.addAll(r7)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mAvailableOpenOrSavedSsidsInScanHistogram     // Catch:{ all -> 0x01b4 }
            int r14 = r5.size()     // Catch:{ all -> 0x01b4 }
            r1.incrementSsid(r13, r14)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mAvailableOpenOrSavedBssidsInScanHistogram     // Catch:{ all -> 0x01b4 }
            r1.incrementBssid(r13, r11)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mAvailableSavedPasspointProviderProfilesInScanHistogram     // Catch:{ all -> 0x01b4 }
            int r14 = r10.size()     // Catch:{ all -> 0x01b4 }
            r1.incrementSsid(r13, r14)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mAvailableSavedPasspointProviderBssidsInScanHistogram     // Catch:{ all -> 0x01b4 }
            r1.incrementBssid(r13, r0)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mObservedHotspotR1ApInScanHistogram     // Catch:{ all -> 0x01b4 }
            r1.incrementTotalPasspointAps(r13, r12)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mObservedHotspotR2ApInScanHistogram     // Catch:{ all -> 0x01b4 }
            r14 = r27
            r1.incrementTotalPasspointAps(r13, r14)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mObservedHotspotR1EssInScanHistogram     // Catch:{ all -> 0x01b4 }
            int r15 = r25.size()     // Catch:{ all -> 0x01b4 }
            r1.incrementTotalUniquePasspointEss(r13, r15)     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mObservedHotspotR2EssInScanHistogram     // Catch:{ all -> 0x01b4 }
            int r15 = r24.size()     // Catch:{ all -> 0x01b4 }
            r1.incrementTotalUniquePasspointEss(r13, r15)     // Catch:{ all -> 0x01b4 }
            java.util.Collection r13 = r25.values()     // Catch:{ all -> 0x01b4 }
            java.util.Iterator r13 = r13.iterator()     // Catch:{ all -> 0x01b4 }
        L_0x016b:
            boolean r15 = r13.hasNext()     // Catch:{ all -> 0x01b4 }
            if (r15 == 0) goto L_0x0189
            java.lang.Object r15 = r13.next()     // Catch:{ all -> 0x01b4 }
            java.lang.Integer r15 = (java.lang.Integer) r15     // Catch:{ all -> 0x01b4 }
            r16 = r0
            android.util.SparseIntArray r0 = r1.mObservedHotspotR1ApsPerEssInScanHistogram     // Catch:{ all -> 0x01b4 }
            r17 = r3
            int r3 = r15.intValue()     // Catch:{ all -> 0x01b4 }
            r1.incrementPasspointPerUniqueEss(r0, r3)     // Catch:{ all -> 0x01b4 }
            r0 = r16
            r3 = r17
            goto L_0x016b
        L_0x0189:
            r16 = r0
            r17 = r3
            java.util.Collection r0 = r24.values()     // Catch:{ all -> 0x01b4 }
            java.util.Iterator r0 = r0.iterator()     // Catch:{ all -> 0x01b4 }
        L_0x0195:
            boolean r3 = r0.hasNext()     // Catch:{ all -> 0x01b4 }
            if (r3 == 0) goto L_0x01ab
            java.lang.Object r3 = r0.next()     // Catch:{ all -> 0x01b4 }
            java.lang.Integer r3 = (java.lang.Integer) r3     // Catch:{ all -> 0x01b4 }
            android.util.SparseIntArray r13 = r1.mObservedHotspotR2ApsPerEssInScanHistogram     // Catch:{ all -> 0x01b4 }
            int r15 = r3.intValue()     // Catch:{ all -> 0x01b4 }
            r1.incrementPasspointPerUniqueEss(r13, r15)     // Catch:{ all -> 0x01b4 }
            goto L_0x0195
        L_0x01ab:
            android.util.SparseIntArray r0 = r1.mObserved80211mcApInScanHistogram     // Catch:{ all -> 0x01b4 }
            r1.increment80211mcAps(r0, r4)     // Catch:{ all -> 0x01b4 }
            monitor-exit(r2)     // Catch:{ all -> 0x01b4 }
            return
        L_0x01b2:
            monitor-exit(r2)     // Catch:{ all -> 0x01b4 }
    ...
    public void logStaEvent(int type, int frameworkDisconnectReason, WifiConfiguration config) {
        switch (type) {
            ...
            case 20:
                ...
                if (config == null) {
                    event.connectSsid = "null";
                } else {
                    event.connectSsid = config.SSID;
                }
                addStaEvent(event);
                return;
            default:
    ...
    public void logStaEvent(int type, String msg) {
        WifiMetricsProto.StaEvent event = new WifiMetricsProto.StaEvent();
        event.errMsg = msg;
        event.type = type;
        addStaEvent(event);
    ...
    public static int supplicantStateToBit(SupplicantState state) {
        switch (C04612.$SwitchMap$android$net$wifi$SupplicantState[state.ordinal()]) {
            case 1:
                return 1;
            case 2:
                return 2;
    ...
    public void logLinkProbeFailure(long timeSinceLastTxSuccessMs, int rssi, int linkSpeed, int reason) {
        synchronized (this.mLock) {
            ...
            this.mProbeElapsedTimeSinceLastUpdateMs = Integer.MAX_VALUE;
