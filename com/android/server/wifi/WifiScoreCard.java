...
public class WifiScoreCard {
    ...
    public void noteSignalPoll(ExtendedWifiInfo wifiInfo) {
        ...
        if (this.mTsRoam > -1 && wifiInfo.getRssi() != -127 && this.mClock.getElapsedSinceBootMillis() - this.mTsRoam >= 4000) {
    ...
    final class PerBssid {
        ...
        PerBssid(String ssid2, MacAddress bssid2) {
            ...
            this.f22id = WifiScoreCard.idFromLong(hash);
            this.changed = false;
        }
        ...
        public PerBssid merge(WifiScoreCardProto.AccessPoint ap) {
            if (ap.hasId() && this.f22id != ap.getId()) {
                return this;
            }
        ...
        public void finishPendingRead() {
            byte[] serialized = this.mPendingReadFromStore.getAndSet((Object) null);
            if (serialized != null) {
                try {
    ...
    public PerBssid lookupBssid(String ssid, String bssid) {
        if (ssid == null || MobileWipsWifiSsid.NONE.equals(ssid) || bssid == null) {
        ...
        try {
            ...
            if (ans == null || !ans.ssid.equals(ssid)) {
                ...
                if (old != null) {
                    Log.i("WifiScoreCard", "Discarding stats for score card (ssid changed) ID: " + old.f22id);
                }
    ...
    public long computeHashLong(String ssid, MacAddress mac) {
        try {
            ...
            Log.e("WifiScoreCard", "Illegal argument " + ssid, e2);
            return 0;
        }
    }
