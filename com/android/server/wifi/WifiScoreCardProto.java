...
public final class WifiScoreCardProto {
    ...
    public enum SecurityType implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<SecurityType> internalValueMap = null;
        private final int value;

        static {
            internalValueMap = new Internal.EnumLiteMap<SecurityType>() {
    ...
    public enum Technology implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<Technology> internalValueMap = null;
        private final int value;

        static {
            internalValueMap = new Internal.EnumLiteMap<Technology>() {
    ...
    public enum Event implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<Event> internalValueMap = null;
        private final int value;
    ...
    public static final class NetworkList extends GeneratedMessageLite<NetworkList, Builder> implements NetworkListOrBuilder {
        ...
        public Network getNetworks(int index) {
            return (Network) this.networks_.get(index);
        }

        public NetworkOrBuilder getNetworksOrBuilder(int index) {
            return (NetworkOrBuilder) this.networks_.get(index);
        }
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (int i = 0; i < this.networks_.size(); i++) {
                output.writeMessage(3, (MessageLite) this.networks_.get(i));
            }
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < this.networks_.size(); i++) {
                size2 += CodedOutputStream.computeMessageSize(3, (MessageLite) this.networks_.get(i));
            }
    ...
    public static final class Network extends GeneratedMessageLite<Network, Builder> implements NetworkOrBuilder {
        ...
        public AccessPoint getAccessPoints(int index) {
            return (AccessPoint) this.accessPoints_.get(index);
        }

        public AccessPointOrBuilder getAccessPointsOrBuilder(int index) {
            return (AccessPointOrBuilder) this.accessPoints_.get(index);
        }
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (int i = 0; i < this.accessPoints_.size(); i++) {
                output.writeMessage(3, (MessageLite) this.accessPoints_.get(i));
            }
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < this.accessPoints_.size(); i++) {
                size2 += CodedOutputStream.computeMessageSize(3, (MessageLite) this.accessPoints_.get(i));
            }
            if ((this.bitField0_ & 4) == 4) {
    ...
    public static final class AccessPoint extends GeneratedMessageLite<AccessPoint, Builder> implements AccessPointOrBuilder {
        ...
        public Signal getEventStats(int index) {
            return (Signal) this.eventStats_.get(index);
        }

        public SignalOrBuilder getEventStatsOrBuilder(int index) {
            return (SignalOrBuilder) this.eventStats_.get(index);
        }
        ...
        public Roam getRoams(int index) {
            return (Roam) this.roams_.get(index);
        }

        public RoamOrBuilder getRoamsOrBuilder(int index) {
            return (RoamOrBuilder) this.roams_.get(index);
        }
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (int i = 0; i < this.eventStats_.size(); i++) {
                output.writeMessage(4, (MessageLite) this.eventStats_.get(i));
            }
            for (int i2 = 0; i2 < this.roams_.size(); i2++) {
                output.writeMessage(5, (MessageLite) this.roams_.get(i2));
            }
            if ((this.bitField0_ & 4) == 4) {
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < this.eventStats_.size(); i++) {
                size2 += CodedOutputStream.computeMessageSize(4, (MessageLite) this.eventStats_.get(i));
            }
            for (int i2 = 0; i2 < this.roams_.size(); i2++) {
                size2 += CodedOutputStream.computeMessageSize(5, (MessageLite) this.roams_.get(i2));
            }
            if ((this.bitField0_ & 4) == 4) {
    ...
    public static final class Signal extends GeneratedMessageLite<Signal, Builder> implements SignalOrBuilder {
        ...
        public void mergeRssi(UnivariateStatistic value) {
            ...
            if (univariateStatistic == null || univariateStatistic == UnivariateStatistic.getDefaultInstance()) {
                ...
                this.rssi_ = (UnivariateStatistic) ((UnivariateStatistic.Builder) UnivariateStatistic.newBuilder(this.rssi_).mergeFrom(value)).buildPartial();
            }
            this.bitField0_ |= 4;
        }
        ...
        public void mergeLinkspeed(UnivariateStatistic value) {
            ...
            if (univariateStatistic == null || univariateStatistic == UnivariateStatistic.getDefaultInstance()) {
                ...
                this.linkspeed_ = (UnivariateStatistic) ((UnivariateStatistic.Builder) UnivariateStatistic.newBuilder(this.linkspeed_).mergeFrom(value)).buildPartial();
            }
            this.bitField0_ |= 8;
        }
        ...
        public void mergeElapsedMs(UnivariateStatistic value) {
            ...
            if (univariateStatistic == null || univariateStatistic == UnivariateStatistic.getDefaultInstance()) {
                ...
                this.elapsedMs_ = (UnivariateStatistic) ((UnivariateStatistic.Builder) UnivariateStatistic.newBuilder(this.elapsedMs_).mergeFrom(value)).buildPartial();
            }
            this.bitField0_ |= 16;
        }
                    ...
                    while (!done) {
                        try {
                            ...
                            if (tag == 0) {
                                ...
                                if (subBuilder != null) {
                                    subBuilder.mergeFrom(this.rssi_);
                                ...
                                if (subBuilder2 != null) {
                                    subBuilder2.mergeFrom(this.linkspeed_);
                                ...
                                if (subBuilder3 != null) {
                                    subBuilder3.mergeFrom(this.elapsedMs_);
