...
public class WrongPasswordNotifier {
    ...
    private void showNotification(String ssid) {
        ...
        this.mNotificationManager.notify(42, this.mFrameworkFacade.makeNotificationBuilder(this.mContext, SystemNotificationChannels.NETWORK_ALERTS).setAutoCancel(true).setTimeoutAfter(CANCEL_TIMEOUT_MILLISECONDS).setSmallIcon(17304154).setContentTitle(this.mContext.getString(17042633)).setContentText(ssid).setContentIntent(this.mFrameworkFacade.getActivity(this.mContext, 0, intent, 134217728)).setColor(this.mContext.getResources().getColor(17170460)).build());
    }

    private void dismissNotification() {
        this.mNotificationManager.cancel((String) null, 42);
    }
}
