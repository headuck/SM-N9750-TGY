...
public abstract class Utils {
    ...
    public static String getRealmForMccMnc(String mccmnc) {
        ...
        return String.format(TelephonyUtil.THREE_GPP_NAI_REALM_FORMAT, new Object[]{mnc, mcc});
    }
    ...
    public static String roamingConsortiumsToString(long[] ois) {
        ...
        return roamingConsortiumsToString((Collection<Long>) list);
    }
    ...
    public static String bytesToBingoCard(ByteBuffer data) {
        ...
        while (dup.hasRemaining()) {
            sbx.append(String.format("%02x ", new Object[]{Integer.valueOf(dup.get() & 255)}));
        }
        ByteBuffer dup2 = data.duplicate();
        sbx.append(' ');
        while (dup2.hasRemaining()) {
            sbx.append(String.format("%c", new Object[]{Character.valueOf(toAscii(dup2.get() & 255))}));
        }
        return sbx.toString();
    }
    ...
    public static String toHMS(long millis) {
        ...
        long time2 = tmp;
        long tmp2 = tmp / 60;
        long s = time2 - (tmp2 * 60);
        long time3 = tmp2;
        long tmp3 = tmp2 / 60;
        long m = time3 - (60 * tmp3);
