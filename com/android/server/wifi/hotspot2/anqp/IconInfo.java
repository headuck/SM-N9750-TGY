...
public class IconInfo {
    ...
    public static IconInfo parse(ByteBuffer payload) {
        return new IconInfo(((int) ByteBufferReader.readInteger(payload, ByteOrder.LITTLE_ENDIAN, 2)) & 65535, ((int) ByteBufferReader.readInteger(payload, ByteOrder.LITTLE_ENDIAN, 2)) & 65535, ByteBufferReader.readString(payload, 3, StandardCharsets.US_ASCII).trim(), ByteBufferReader.readStringWithByteLength(payload, StandardCharsets.US_ASCII), ByteBufferReader.readStringWithByteLength(payload, StandardCharsets.UTF_8));
    }
