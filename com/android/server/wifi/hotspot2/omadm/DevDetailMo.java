...
public class DevDetailMo {
    ...
    static {
        ...
        sEapMethods.add(Pair.create(13, (Object) null));
        sEapMethods.add(Pair.create(18, (Object) null));
        sEapMethods.add(Pair.create(23, (Object) null));
        sEapMethods.add(Pair.create(50, (Object) null));
    ...
    public static String serializeToXml(Context context, SystemInfo info, String redirectUri) {
        ...
        try {
            ...
            for (Pair<Integer, String> entry : sEapMethods) {
                int i2 = i + 1;
                Element eapMethodNode = moSerializer.createNode(doc, String.format("%s%02d", new Object[]{TAG_EAP_METHOD, Integer.valueOf(i2)}));
                int i3 = i2;
            ...
            for (String macAddress3 : sSupportedOps) {
                opsNode.appendChild(moSerializer.createNodeForValue(doc, macAddress3, ""));
                eapMethodListNode = eapMethodListNode;
                macAddress = macAddress;
            }
            Element element = eapMethodListNode;
