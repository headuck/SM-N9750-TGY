...
public class SppConstants {
    ...
    public static final List<String> SUPPORTED_MO_LIST = Arrays.asList(new String[]{"urn:wfa:mo:hotspot2dot0-perprovidersubscription:1.0", DevDetailMo.HS20_URN, DevInfoMo.URN, DevDetailMo.URN});
    ...
    public class SppStatus {
        ...
        /* renamed from: OK */
        public static final int f27OK = 0;
