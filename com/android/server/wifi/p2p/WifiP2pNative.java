...
public class WifiP2pNative {
    ...
    public boolean p2pFind(int timeout, int channelNum) {
        return this.mSupplicantP2pIfaceHal.find(timeout, channelNum);
    }

    public boolean p2pGroupAdd(boolean persistent, int freq) {
        return this.mSupplicantP2pIfaceHal.groupAdd(persistent, freq);
    }

    public boolean p2pRemoveClient(String deviceAddress, boolean iface) {
        return this.mSupplicantP2pIfaceHal.p2pRemoveClient(deviceAddress, iface);
    }
    ...
    public boolean p2pListen(int timeout) {
        return this.mSupplicantP2pIfaceHal.p2pListen(timeout);
    }

    public boolean p2pSet(String cmd, String param) {
        return this.mSupplicantP2pIfaceHal.p2pSet(cmd, param);
    }

    public String p2pGetModelName(String deviceAddress) {
        return this.mSupplicantP2pIfaceHal.p2pGetAttribute("model_name", deviceAddress);
    }

    public String p2pGetManufacturer(String deviceAddress) {
        return this.mSupplicantP2pIfaceHal.p2pGetAttribute("manufacturer", deviceAddress);
    }

    public String p2pGetDeviceType(String deviceAddress) {
        return this.mSupplicantP2pIfaceHal.p2pGetAttribute("pri_dev_type", deviceAddress);
    }

    public String p2pGetPeerGoIntent(String deviceAddress) {
        return this.mSupplicantP2pIfaceHal.p2pGetAttribute("go_intent", deviceAddress);
    }

    public String p2pGetListenFreq(String deviceAddress) {
        return this.mSupplicantP2pIfaceHal.p2pGetAttribute("listen_freq", deviceAddress);
    }

    public boolean p2pRemoveNetworks() {
        return this.mSupplicantP2pIfaceHal.removePersistentGroups();
    }

    public String p2pPeer(String deviceAddress) {
        return this.mSupplicantP2pIfaceHal.p2pGetPeerInfo(deviceAddress);
    }

    public boolean startP2pListenOffloading(int channel, int period, int interval, int count) {
        return this.mSupplicantP2pIfaceHal.startP2pListenOffloading(channel, period, interval, count);
    }

    public boolean stopP2pListenOffloading() {
        return this.mSupplicantP2pIfaceHal.stopP2pListenOffloading();
    }

    public boolean setP2pNoa(String iface, boolean enabled, int noa_dur) {
        return this.mSupplicantP2pIfaceHal.setP2pNoa(iface, enabled, noa_dur);
    }

    public boolean setP2pIncBw(String iface, boolean enabled, int inc_bw) {
        return this.mSupplicantP2pIfaceHal.setP2pIncBw(iface, enabled, inc_bw);
    }
