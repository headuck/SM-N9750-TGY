        ...
        public int encodeUtf8(CharSequence in, byte[] out, int offset, int length) {
            ...
            while (inIx < inLimit) {
                ...
                if (c5 < c && outIx < outLimit2) {
                    ...
                    if (outIx <= outLimit2 - 4) {
                        if (inIx + 1 != inLimit) {
                            ...
                            if (Character.isSurrogatePair(c5, charAt2)) {
                                ...
                                UNSAFE.putByte(bArr, outIx5, (byte) (((codePoint >>> 12) & 63) | 128));
                                long outIx7 = outIx6 + 1;
                                c2 = 128;
                                UNSAFE.putByte(bArr, outIx6, (byte) (((codePoint >>> 6) & 63) | 128));
                                j2 = 1;
                                UNSAFE.putByte(bArr, outIx7, (byte) ((codePoint & 63) | 128));
                                outIx = outIx7 + 1;
                            }
                        }
                    ...
                    UNSAFE.putByte(bArr, outIx8, (byte) ((c5 & '?') | 128));
                    str2 = str3;
                    outIx = outIx8 + 1;
                    j2 = 1;
                    outLimit = outLimit2;
            ...
            if (((long) inLimit) <= outLimit2 - outIx4) {
                ...
                while (inIx < inLimit) {
                    ...
                    if (c5 < c && outIx < outLimit2) {
                        ...
                        outIx = outIx10 + 1;
                        UNSAFE.putByte(outIx10, (byte) ((c5 & '?') | 128));
                        outLimit = outLimit2;
                        c2 = 128;
                        outIx2 = 1;
                    }
