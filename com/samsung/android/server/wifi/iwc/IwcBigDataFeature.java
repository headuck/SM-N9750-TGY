...
public abstract class IwcBigDataFeature {
    ...
    public IwcBigDataFeature(boolean dqaEnabled, String dqaFeatureName) {
    ...
    public void addOrUpdateValue(String key, boolean value) {
        if (DBG) {
            String str = this.TAG;
            Log.d(str, "addOrUpdateValue - " + key + ", " + value);
        }
