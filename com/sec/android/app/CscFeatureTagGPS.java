...
public class CscFeatureTagGPS {
    ...
    public static final String TAG_CSCFEATURE_GPS_CONFIGESEXTENSIONSEC = "CscFeature_GPS_ConfigEsExtensionSec";
    public static final String TAG_CSCFEATURE_GPS_CONFIGEXCEPTIONMASKFORAGNSS = "CscFeature_GPS_ConfigExceptionMaskForAGNSS";
    public static final String TAG_CSCFEATURE_GPS_CONFIGGPFD = "CscFeature_GPS_ConfigGPFD";
    public static final String TAG_CSCFEATURE_GPS_CONFIGLPPBITMASK = "CscFeature_GPS_ConfigLppBitmask";
    ...
    public static final String TAG_CSCFEATURE_GPS_SUPPORTENABLEAGPS = "CscFeature_GPS_SupportEnableAgps";
