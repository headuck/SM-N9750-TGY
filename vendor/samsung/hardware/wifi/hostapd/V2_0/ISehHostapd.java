...
public interface ISehHostapd extends IHostapd {
    ...
    public static final class SehParams {
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            ...
            this.apIsolate = hwBlob.getBool(_hidl_offset + 0);
            this.maxNumSta = hwBlob.getInt32(_hidl_offset + 4);
            this.vendorIe = hwBlob.getString(_hidl_offset + 8);
            parcel.readEmbeddedBuffer((long) (this.vendorIe.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 8 + 0, false);
            this.pmf = hwBlob.getBool(_hidl_offset + 24);
            this.macAddressAcl = hwBlob.getInt32(_hidl_offset + 28);
        }
    ...
    public static abstract class Stub extends HwBinder implements ISehHostapd {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISehHostapd.kInterfaceName, android.hardware.wifi.hostapd.V1_1.IHostapd.kInterfaceName, android.hardware.wifi.hostapd.V1_0.IHostapd.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-56, 68, 1, -21, -56, 94, -30, 93, 120, 82, -41, 120, 72, -115, -9, 108, -39, 2, -8, 53, -2, 90, -22, 25, -63, -6, 90, -93, -76, 44, 55, -123}, new byte[]{47, -82, 97, -23, 98, -10, Byte.MIN_VALUE, -111, 51, 95, Byte.MAX_VALUE, -12, 88, 31, -49, -30, -30, -116, -25, -10, 19, 45, 122, 113, 47, -95, 61, 121, 101, 84, 62, 77}, new byte[]{-18, 8, SemWifiApSmartUtil.BLE_BATT_5, 13, -30, 28, -76, 30, 62, -62, 109, 110, -42, 54, -57, 1, -73, -9, 5, 22, -25, 31, -78, 47, 79, -26, 10, 19, -26, 3, -12, 6}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}}));
        }
