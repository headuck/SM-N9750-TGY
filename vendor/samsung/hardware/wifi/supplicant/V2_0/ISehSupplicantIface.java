...
public interface ISehSupplicantIface extends IBase {
    public static final String kInterfaceName = "vendor.samsung.hardware.wifi.supplicant@2.0::ISehSupplicantIface";
    ...
    public interface getNetworkCallback {
        void onValues(SupplicantStatus supplicantStatus, ISehSupplicantNetwork iSehSupplicantNetwork);
    }
    ...
    static ISehSupplicantIface asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof ISehSupplicantIface)) {
            return (ISehSupplicantIface) iface;
        }
        ISehSupplicantIface proxy = new Proxy(binder);
        try {
    ...
    static ISehSupplicantIface castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static ISehSupplicantIface getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static ISehSupplicantIface getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static ISehSupplicantIface getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static ISehSupplicantIface getService() throws RemoteException {
        return getService("default");
    }

    public static final class Proxy implements ISehSupplicantIface {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.samsung.hardware.wifi.supplicant@2.0::ISehSupplicantIface]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISehSupplicantIface {
        public IHwBinder asBinder() {
            return this;
        }

        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISehSupplicantIface.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final String interfaceDescriptor() {
            return ISehSupplicantIface.kInterfaceName;
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-10, 102, -60, 84, 28, 44, 90, -83, -86, -28, 12, -90, 57, -54, 114, -42, -61, 35, -85, -4, 7, 96, -70, -29, -66, SemWifiApSmartUtil.BLE_BATT_3, -36, 50, 46, 3, -108, -52}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}}));
        }
        ...
        public IHwInterface queryLocalInterface(String descriptor) {
            if (ISehSupplicantIface.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
