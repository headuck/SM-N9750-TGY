...
public interface ISehSupplicantNetwork extends IBase {
    public static final String kInterfaceName = "vendor.samsung.hardware.wifi.supplicant@2.0::ISehSupplicantNetwork";
    ...
    static ISehSupplicantNetwork asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof ISehSupplicantNetwork)) {
            return (ISehSupplicantNetwork) iface;
        }
        ISehSupplicantNetwork proxy = new Proxy(binder);
        try {
    ...
    static ISehSupplicantNetwork castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static ISehSupplicantNetwork getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static ISehSupplicantNetwork getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static ISehSupplicantNetwork getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static ISehSupplicantNetwork getService() throws RemoteException {
        return getService("default");
    }

    public static final class Proxy implements ISehSupplicantNetwork {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.samsung.hardware.wifi.supplicant@2.0::ISehSupplicantNetwork]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISehSupplicantNetwork {
        public IHwBinder asBinder() {
            return this;
        }

        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISehSupplicantNetwork.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final String interfaceDescriptor() {
            return ISehSupplicantNetwork.kInterfaceName;
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-45, 78, 52, -55, 46, 44, 97, 88, 19, 103, -56, 66, 122, -120, 68, 126, -28, 9, -33, 33, -45, -53, -94, -80, 58, -78, 50, 80, 88, 79, -37, 77}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}}));
        }
        ...
        public IHwInterface queryLocalInterface(String descriptor) {
            if (ISehSupplicantNetwork.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
